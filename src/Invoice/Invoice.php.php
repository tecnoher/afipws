...
namespace App\Libraries\AfipFE\lib;
...
use App\Libraries\AfipFE\lib\fpdf;
...
class Invoice extends FPDF
{
    ...
    public function Rotate($ang, $x = -1, $y = -1)
    {
        if ($x == -1) {
            $x = $this->x;
        }
    ...
    public function RotatedText($x, $y, $txt, $ang)
    {
    ...
    public function Head($data)
    {
        ...
        $this->Image('storage/tiendaLogos/'.$logo, 10, 8);
    ...
    public function getTextInvoice($tipoComp)
    {
        switch ($tipoComp) {
            case 1:
            case 6:
    ...
    public function getInvoiceLetter($tipoComp)
    {
        switch ($tipoComp) {
            case 1:
            case 2:
    ...
    public function THead($text, $color)
    {
...
//		$this->Cell(array_sum($w), 0, '', 'T');
    ...
    public function Base($data, $final = true)
    {
        $this->SetFillColor($data['color']['red'], $data['color']['green'], $data['color']['blue']);
        $this->SetTextColor(255);
        $this->SetDrawColor(123, 122, 122);
    ...
    public function NextIvoice($text)
    {
        $this->SetFont('UniFont', '', 12);
        $this->SetTextColor(0, 0, 0);
        $this->SetY(258);
